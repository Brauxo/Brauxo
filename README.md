...
<!-- blog:START -->* [Franca: Nested Matryoshka Clustering for Scalable Visual Representation
  Learning](http://arxiv.org/abs/2507.14137v1) - _Published on $publish_date_* [Toward Temporal Causal Representation Learning with Tensor Decomposition](http://arxiv.org/abs/2507.14126v1) - _Published on $publish_date_* [Kolmogorov Arnold Networks &lpar;KANs&rpar; for Imbalanced Data -- An Empirical
  Perspective](http://arxiv.org/abs/2507.14121v1) - _Published on $publish_date_* [Harmony in Divergence: Towards Fast, Accurate, and Memory-efficient
  Zeroth-order LLM Fine-tuning](http://arxiv.org/abs/2502.03304v2) - _Published on $publish_date_* [A General Framework for Inference-time Scaling and Steering of Diffusion
  Models](http://arxiv.org/abs/2501.06848v5) - _Published on $publish_date_<!-- blog:END -->
